...
SamplePlayer* gameMoveSoundPlayer;
SamplePlayer* gameCollectSoundPlayer;
SamplePlayer* gameExplodeSoundPlayer;
...
AudioSample* gameMoveSound;
AudioSample* gameCollectSound;
AudioSample* gameExplodeSound;
...
void initSound(void)
{
    ...
    gameMoveSoundPlayer = loadSoundFile(gameMoveSound, "sound/move");
    gameExplodeSoundPlayer = loadSoundFile(gameExplodeSound, "sound/explode");
    gameCollectSoundPlayer = loadSoundFile(gameCollectSound, "sound/collect");
}
...
void deInitSound(void)
{
    ...
    FreeSample(gameMoveSound);
    FreeSample(gameExplodeSound);
    FreeSample(gameCollectSound);
    ...
    FreeSoundPlayer(gameMoveSoundPlayer);;
	FreeSoundPlayer(menuBackSoundPlayer);
    FreeSoundPlayer(gameExplodeSoundPlayer);
    FreeSoundPlayer(gameCollectSoundPlayer);
}
...
{
    playSound(gameExplodeSoundPlayer);
}

void playGameCollectSound(void)
{
    playSound(gameCollectSoundPlayer);
}

void playGameMoveSound(void)
{
    playSound(gameMoveSoundPlayer);
}
